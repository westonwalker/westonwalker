    ...
    <div>
        ...
        <div v-if="shouldShowModal" class="fixed inset-0 z-30 flex justify-center items-center">
            ...
            <div class="relative z-50 w-[350px] h-[550px] md:w-[450px] bg-gray-50 rounded-md shadow-2xl">
                ...
                <nuxt-img format="webp" src="/avatar.png" alt="The Freelance Avatar" 
                ...
                <div class="px-6">
                    ...
                    <script async data-uid="214738e39f" src="https://fabulous-inventor-6805.ck.page/214738e39f/index.js"></script>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        showDev: function() {
            ...
            if (localStorage.lastSeen && triggerDate.getTime() < localStorage.lastSeen) {
                return;
            }
            localStorage.lastSeen = new Date().getTime();

            this.shouldShowDev = true;
            // use arrow function, otherwise "this" is referring to the anonymous funciton, not the parent object.
            setTimeout(() => {
                this.slideInClass = 'left-6';
            }, 5000);
        },
        hideDev: function() {
            this.slideInClass = '-left-56';
        },
        showModal: function() {
            this.shouldShowDev = false;
